...
async def draw(messages_queue, sending_queue, status_updates_queue, saved_message_queue):
    root = tk.Tk()
    ...
    async with anyio.create_task_group() as tg:
        ...
        tg.start_soon(update_conversation_history, conversation_panel, saved_message_queue)
